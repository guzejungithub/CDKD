...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.coord_representation == 'simdr':
            ...
            target_weight, filtered_joints = self.filter_target_simdr(joints_split.copy(), joints_vis,
                                                                        self.image_size * self.simdr_split_ratio)
            return input1, input2, filtered_joints[:, 0:2], target_weight, meta
            ...
            target_weight = torch.from_numpy(target_weight)
            return input1, input2, target_x, target_y, target_weight, meta
        elif self.coord_representation == 'heatmap':
            return input1, input2, target, target_weight, meta
